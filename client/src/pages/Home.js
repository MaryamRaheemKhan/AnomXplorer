...
const Container = styled.div`
  ...
  height: 95vh; /* Use viewport height instead of percentage */
  width: 100%;
  background: linear-gradient(to bottom right, #000, #001f3f);
  overflow-x: hidden;
  color: #eee;
`;
  ...
  return (
    <Container>
      <motion.div variants={containerVariants} initial="hidden" animate="visible">
        <Content>
          <h1 style={{fontSize:40}}>            AnomXplorer
</h1>
          <Title variants={titleVariants} style={{fontSize:35}}>
